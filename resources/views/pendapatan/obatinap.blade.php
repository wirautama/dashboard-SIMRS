...
@section('title')
<title>{{ config('app.name', 'Laravel') }} :: {{ __('Obat Rawat Inap')  }}</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Honor Dokter Dan Pendapatan Obat Rawat Inap</h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('manager.home') }}">Home</a></li>
              <li class="breadcrumb-item active">Obat Rawat Inap</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Obat Rawat Inap <div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="data-obat-inap" style="width: 100% !important">
                        <thead>
                            <tr>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#data-obat-inap')) {
          datatableObatInap = $('#data-obat-inap').DataTable().destroy();
        }

        datatableObatInap = $('#data-obat-inap').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
            ...
            ajax:{
                url: "{{ route('pendapatan.obatinap.list') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd, 
            ...
            columns:[
                ...
                { data: 'nota_inap', name: 'nota_inap', className: 'dt-body-right',
                    render: data => {
