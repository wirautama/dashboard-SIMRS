...
@section('title')
<title>{{ config('app.name', 'Laravel') }} :: {{ __('Anestesi')  }}</title>
@endsection
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tindakan Anestesi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Tindakan Anestesi <div id ="filter_period_id"></div></h3>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        datatableRalan = $('#data-tindakan-ralan').DataTable({
            ...
            ajax:{
                url: "{{ route('pendapatan.anestesi.list') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd, 
            ...
            columns:[
                ...
                { data: 'nm_dokter_anestesi', name: 'nm_dokter_anestesi'},
                { data: 'nm_perawatan', name: 'nm_perawatan'},
                { data: 'status', name: 'status'},
                { data: 'biayadokter_anestesi', name: 'biayadokter_anestesi', className: 'dt-body-right',
                    render: data => {
