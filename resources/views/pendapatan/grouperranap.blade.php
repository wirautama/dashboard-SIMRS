...
@section('title')
<title>{{ config('app.name', 'Laravel') }} :: {{ __('Grouper Rawat Inap')  }}</title>
@endsection
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Grouper Rawat Inap <div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="data-grouper-ranap" style="width: 100% !important">
                        <thead>
                            <tr>
                              ...
                              <th>Obat</th>
                              <th>Retur Obat</th>
                              <th>T. Setelah Retur Obat (No PPN)</th>
                            </tr>
                        </thead>
                    </table>
                    <!-- /.table -->
    ...
    $('#submit-filter').click(function(e) {
        ...
        datatableGrouperRanap = $('#data-grouper-ranap').DataTable({
            ...
            columns:[
                ...
                { data: 'diagnosa_akhir', name: 'diagnosa_akhir'},
                ...
                { data: 'tindakan_poli', name: 'tindakan_poli'},
                { data: 'laborat', name: 'laborat'},
                { data: 'radiologi', name: 'radiologi'},
                { data: 'obat', name: 'obat'},
                { data: 'retur_obat', name: 'retur_obat'},
                { data: 'total_obat_setelah_retur_belum_ppn', name: 'total_obat_setelah_retur_belum_ppn'},
