...
@section('title')
<title>{{ config('app.name', 'Laravel') }} :: {{ __('Grouper Rawat Jalan')  }}</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Grouper Rawat Jalan</h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('manager.home') }}">Home</a></li>
              <li class="breadcrumb-item active">Grouper Rawat Jalan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Grouper Rawat Jalan <div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="data-grouper-ralan" style="width: 100% !important">
                        <thead>
                            <tr>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#data-grouper-ralan')) {
          datatableGrouperRalan = $('#data-grouper-ralan').DataTable().destroy();
        }

        datatableGrouperRalan = $('#data-grouper-ralan').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
            ...
            ajax:{
                url: "{{ route('pendapatan.grouperralan.list') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd, 
