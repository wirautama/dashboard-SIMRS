...
@section('title')
<title>{{ config('app.name', 'Laravel') }} :: {{ __('Rawat Inap')  }}</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tindakan Rawat Inap</h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('manager.home') }}">Home</a></li>
              <li class="breadcrumb-item active">Tindakan Rawat Inap</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Tindakan Rawat Inap <div id ="filter_period_id"></div></h3>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        datatableRalan = $('#data-tindakan-ralan').DataTable({
            ...
            ajax:{
                url: "{{ route('pendapatan.ranap.list') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd, 
            ...
            columns:[
                ...
                { data: 'biaya_rawat', name: 'biaya_rawat', className: 'dt-body-right',
                    render: data => {
