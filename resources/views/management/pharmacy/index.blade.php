...
@section('title')
<title>{{ config('app.name', 'Laravel') }} :: {{ __('Obat Bebas')  }}</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pendapatan Obat Bebas</h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('manager.home') }}">Home</a></li>
              <li class="breadcrumb-item active">Obat Bebas</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Obat Bebas<div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="data-obat-bebas" style="width: 100% !important">
                        <thead>
                            <tr>
                              <th>Tgl. Jual</th>
                              <th>No. Rawat</th>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#data-obat-bebas')) {
          datatableObatBebas = $('#data-obat-bebas').DataTable().destroy();
        }

        datatableObatBebas = $('#data-obat-bebas').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
            ...
            ajax:{
                url: "{{ route('manager.obatbebas.list') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd, 
