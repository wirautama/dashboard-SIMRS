...
@section('title')
<title>{{ config('app.name', 'Laravel') }} :: {{ __('Pemeriksaan Radiologi')  }}</title>
@endsection
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Pemeriksaan Radiologi <div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="data-tindakan-radiologi" style="width: 100% !important">
                        <thead>
                            <tr>
                              <th>No. Rawat</th>
                              <th>No. Nota Ralan</th>
...
$(document).ready(function () {
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#data-tindakan-radiologi')) {
          datatableRadiologi = $('#data-tindakan-radiologi').DataTable().destroy();
        }

        datatableRadiologi = $('#data-tindakan-radiologi').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
            ...
            ajax:{
                url: "{{ route('manager.radiology.list') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd, 
            ...
            columns:[
                ...
                { data: 'nm_dokter_perujuk', name: 'nm_dokter_perujuk'},
                { data: 'nm_perawatan', name: 'nm_perawatan'},
                { data: 'status', name: 'status'},
                { data: 'unit', name: 'unit'},
                { data: 'biaya', name: 'biaya', className: 'dt-body-right',
                    render: data => {
