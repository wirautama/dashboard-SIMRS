...
@section('title')
<title>{{ config('app.name', 'Laravel') }} :: {{ __('Pemeriksaan Laborat')  }}</title>
@endsection
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pemeriksaan Laborat</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
              <div class="card">
                <div class="card-header border-0">
                  <h3 class="card-title">Data Pemeriksaan Laborat <div id ="filter_period_id"></div></h3>
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-striped" id="data-tindakan-laborat" style="width: 100% !important">
                        <thead>
                            <tr>
                              <th>Tgl. Periksa Lab</th>
                              <th>No. Nota Ralan</th>
                              <th>No. Nota Ranap</th>
                              <th>No. Order</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="filter_doctor_perujuk">@Lang('common.doctor_perujuk'):</label>
                            <select name="filter_doctor_perujuk" id="filter_doctor_perujuk" class="form-control">
                              <option value="all">Semua</option>
                              @foreach($perujuk as $p )
...
$(document).ready(function () {
    var dateEnd;
    var dateStart;
    var datatableLaborat;
    var selectedDoctorPerujuk;
    ...
    $('#filter_doctor_perujuk').change(function(){
        selectedDoctorPerujuk = $(this).val();
    });
    ...
    $('#submit-filter').click(function(e) {
        ...
        if ( $.fn.dataTable.isDataTable('#data-tindakan-laborat')) {
          datatableLaborat = $('#data-tindakan-laborat').DataTable().destroy();
        }

        datatableLaborat = $('#data-tindakan-laborat').DataTable({
            responsive: true, 
            lengthChange: false, 
            autoWidth: false,
            dom: 'Bfrtip',
            ...
            ajax:{
                url: "{{ route('manager.laborat.list') }}",
                type: 'GET',
                data:{
                  start: dateStart, 
                  end: dateEnd, 
                  perujuk: selectedDoctorPerujuk, 
                  penjamin: selectedPenjamin
                }
            },

            columns:[
                { data: 'tgl_input_hasil_lab', name: 'tgl_input_hasil_lab',
                    render: data => {
                ...
                { data: 'tindakan_lab', name: 'tindakan_lab'},
