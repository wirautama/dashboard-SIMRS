...
class TindakanAnestesiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pendapatan.anestesi', compact('modul', 'doctor', 'penjab'));
    }
    ...
    {   
        ...
        if(request()->ajax()){
            ...
            $sql = "select a.no_rawat, 
                    ...
                    a.tgl_operasi, 
                    a.kategori, 
                    e.nm_dokter as nm_dokter_anestesi, 
                    a.biayadokter_anestesi 
                    FROM operasi a
                    ...
                    LEFT JOIN dokter e on a.dokter_anestesi = e.kd_dokter
            ...
            $sql = ($doctor!="all") ? $sql."and a.dokter_anestesi= '".$doctor."' ": $sql." ";
        ...
        $modul = $this->menu;
        return view('pendapatan.anestesi', compact('modul'));
